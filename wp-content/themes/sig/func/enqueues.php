...
if ( ! function_exists( 'sig_scripts' ) ) {
	function sig_scripts() {     
		...
		wp_enqueue_script( 'sig-scripts', get_template_directory_uri() . '/assets/js/sig_scripts.js', array( 'jquery' ), $jsvendor, true );
        
		wp_enqueue_script( 'sig', get_template_directory_uri() . '/assets/js/sig.js', array( 'jquery' ), $jscustom, true );	
