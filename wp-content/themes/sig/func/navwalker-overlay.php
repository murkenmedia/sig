...
class OverlayMenuWalker extends Walker_Nav_Menu { 
  ...
  function start_lvl( &$output, $depth = 0, $args = array() ) {
    ...
    $output	.= "\n$indent<ul class=\"dropdown-menu$submenu depth_$depth\" role=\"presentation\">\n";
  }
  ...
  function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
    ...
    if (in_array('new-column', $classes)) {
        //NEW COLUMN
        $output .= '<ul class="overlay-nav" role="presentation">';
        
    } else if (in_array('end-column', $classes)) {
        //END COLUMN
        $output .= '</ul>';
