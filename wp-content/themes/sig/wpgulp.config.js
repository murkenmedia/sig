...
const jsVendorFile = 'sig_scripts';
...
const textDomain = 'SIG';

// Name of the translation file.
const translationFile = 'SIG.pot';

// Where to save the translation files.
const translationDestination = './languages';

// Package name.
const packageName = 'SIG';

// Where can users report bugs.
const bugReport = 'https://murkenmedia.com/contact/';

// Last translator Email ID.
const lastTranslator = 'Brian Murken <brian@murkenmedia.com>';

// Team's Email ID.
const team = 'BrianMurken <brian@murkenmedia.com>';
